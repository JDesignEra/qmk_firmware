...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_CODE] = LAYOUT(
        ...
        TD_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,                              KC_UP,            \
        TD_LCTL, KC_LGUI, TD_LALT,                   KC_SPC,                             KC_RALT, M_CODEF, KC_MYCM, KC_RCTL,            KC_LEFT, KC_DOWN, KC_RGHT  \
    ),
    [_CODE_FN] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______,  _______, _______, _______, _______, PC_WAKE,            KC_PSCR, KC_SLCK, KC_PAUS, \
